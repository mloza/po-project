...
public class EditVisit_GUI extends JDialog {
	...
	class listModel extends AbstractListModel {
		...
		public Objaw getElementObjawAt(int index) {
			return objawy.get(index);
		}
	...
	public EditVisit_GUI(final Wizyta visit) {
		...
		getContentPane().add(contentPanel, BorderLayout.NORTH);
		{
			...
			final JFormattedTextField formattedTextField = new JFormattedTextField(
					factory, visit.getDateOfVisit().getTime());
			...
			okButton.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					...
					for (int i : list.getSelectedIndices()) {
						objawy.add(((listModel) list.getModel()).getElementObjawAt(i));
					}
					visit.objawy = objawy;
